                ...
                <ul class="nav nav-pills ml-auto p-2">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('inputdata')); ?>" class="nav-link <?php echo classActiveSegment(2, 'form01'); ?>">F1 - S. Pengajuan Ke Bend</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F2 - Daftar Rek. Pemindah Bukuan</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F3 - Nota Pencairan Dana (NPD)</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F4 - Kartu Kendali Kegiatan</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F5 - Rincian Objek</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F6 - Kwitansi</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F7 - Daftar Hadir</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F8 - Daftar Penerimaan</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F9 - Bukti Pemotongan</a>
                      <a class="dropdown-item" tabindex="-1" href="#">F10 - SK</a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div id="accordion">
                  ...
                  <td>
                      <button type="button" class="btn btn-block btn-warning btn-lg">MULAI</button>
                    </td>
                </div>
              </div>
              <!-- /.card-body -->
