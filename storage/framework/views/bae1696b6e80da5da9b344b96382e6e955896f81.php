        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo e(route('inputdata')); ?>">Input Data</a></li>
   ...
   <div class="card card-warning">
      <div class="card-header">
              ...
              <div class="card-body">
                ...
                <div class="col-12">
                  <a href="<?php echo e(route('lapform01')); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
