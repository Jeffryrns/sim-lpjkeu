                ...
                <ul class="nav nav-pills ml-auto p-2">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form01')); ?>">F1 - S. Pengajuan Ke Bend</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form02')); ?>">F2 - Daftar Rek. Pemindah Bukuan</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form03')); ?>">F3 - Nota Pencairan Dana (NPD)</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form04')); ?>">F4 - Kartu Kendali Kegiatan</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form05')); ?>">F5 - Rincian Objek</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form06')); ?>">F6 - Kwitansi</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form07')); ?>">F7 - Daftar Hadir</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form08')); ?>">F8 - Daftar Penerimaan</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form09')); ?>">F9 - Bukti Pemotongan</a>
                      <a class="dropdown-item" tabindex="-1" href="<?php echo e(route('form10')); ?>">F10 - SK</a>
                    </div>
                  </li>
                </ul>
              </div><!-- /.card-header -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div id="accordion">
                  ...
                  <td>
                      <a href="<?php echo e(route('form01')); ?>" type="button" class="btn btn-block btn-warning btn-lg">MULAI</button></a>
                    </td>
                </div>
              </div>
              <!-- /.card-body -->
